...
- 解決した．
- 人工粘性は，タイムステップを更新する前の数値で計算すべきだった．
- `2d/sedov`では円柱座標系でsedov解を解いた．
- `2d/sedov_w_B`では，sedov解に対して，単純な磁場の形$B_z = 10^{-2}$を仮定してこれを初期条件として解いた．$B_z$の値が大きい時は，数値的な振動が発生していて，うまく解けなかった．
- 円柱座標系での磁力線の書き方を詳しく考える必要がある．ベクトルポテンシャル$A_\phi$でかけそうとのことだが，$A_\phi$の初期条件の与え方が悪いのか，うまく磁力線のかたちになってくれない．困った．
